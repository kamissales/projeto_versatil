...
<main class="container">
    <div class="pt-5 row justify-content-center">
        ...
        <h3 style="color:white">Entre com as suas credenciais:</h3>
        ...
        <form method="POST" class="needs-validation" novalidate>
            <div class="form-group">
                ...
                <div class="invalid-feedback" style="color:white">Seu usuário deve ser um e-mail válido</div>
            </div>

            <div class="form-group">
                <label for="senha" style="color:white">Senha:</label>
                <input type="password" name="senha" required class="form-control" minlength="8">
                <div class="invalid-feedback" style="color:white">Sua senha deve possuir ao menos 8 dígitos</div>
            </div>
